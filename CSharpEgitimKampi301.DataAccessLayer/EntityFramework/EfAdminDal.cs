...
Bunlar Entity`e özgü olmayan metotlardır. (Sistemdeki bütün entityler için geçerli)

İçinde a harfi geçmeyen kullanıcıları listele
Entitye özgü olan bir metottur.
Hepsini kapsamayan sadece 1 entity için çalışan bir method
 */