...
namespace CSharpEgitimKampi301.EFProject
{
    public partial class FrmNewLocation : Form
    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            uptadedValue.DayNight = txtDayNight.Text; 
            uptadedValue.Price = decimal.Parse(txtPrice.Text);
            uptadedValue.Capacity=byte.Parse(nudCapacity.Value.ToString());
            uptadedValue.City = txtCity.Text;   
            uptadedValue.Country = txtCountry.Text; 
            uptadedValue.GuideId = int.Parse(cmbGuide.SelectedValue.ToString());
            db.SaveChanges();
